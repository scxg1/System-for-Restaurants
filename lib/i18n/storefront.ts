...
const translations: Record<string, Record<StorefrontLang, string>> = {
    ...
    "checkout.gpsAuto": { de: "Standort automatisch ermitteln", ar: "تحديد الموقع تلقائياً" },
    "checkout.gpsHint": { de: "GPS verwenden, um Ihre Adresse zu finden", ar: "استخدم GPS لتحديد عنوانك بدقة" },
    "checkout.locating": { de: "Standort wird ermittelt...", ar: "جاري تحديد الموقع..." },
    "checkout.gpsRedo": { de: "Standort neu ermitteln", ar: "إعادة تحديد الموقع" },
    "checkout.manualAddress": { de: "oder Adresse manuell eingeben", ar: "أو أدخل العنوان يدوياً" },
    "checkout.editAddress": { de: "Bearbeiten", ar: "تعديل" },
    "checkout.doneEditing": { de: "Fertig", ar: "تم" },
    "checkout.gpsNotSupported": { de: "Geolocation wird nicht unterstützt", ar: "تحديد الموقع غير مدعوم في متصفحك" },
    "checkout.gpsDenied": { de: "Standortzugriff wurde verweigert", ar: "تم رفض الوصول إلى الموقع" },
    "checkout.gpsUnavailable": { de: "Standort nicht verfügbar", ar: "الموقع غير متاح" },
    "checkout.gpsTimeout": { de: "Zeitüberschreitung bei Standortsuche", ar: "انتهت مهلة تحديد الموقع" },
    "checkout.gpsError": { de: "Fehler bei Standortermittlung", ar: "خطأ في تحديد الموقع" },
    "checkout.gpsAccuracy": { de: "Genauigkeit", ar: "الدقة" },
    "checkout.gpsCoords": { de: "Koordinaten", ar: "الإحداثيات" },
    "checkout.gpsConfirmPin": { de: "Pin auf Karte verschieben für genaue Position", ar: "حرّك الدبوس على الخريطة لتحديد الموقع بدقة" },
    "checkout.notesLabel": { de: "Anmerkungen (optional)", ar: "ملاحظات (اختياري)" },
    "checkout.notesHint": { de: "z.B. Klingel defekt, 2. Etage, ohne Zwiebel...", ar: "مثل: الجرس معطل، الطابق الثاني، بدون بصل..." },
    "checkout.payment.onlineSoon": { de: "(bald verfügbar)", ar: "(قريباً)" },
