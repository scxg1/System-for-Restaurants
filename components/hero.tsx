        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left order-2 md:order-1">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-4">
              <span className="text-primary">{settings.name.toUpperCase()}</span>
            </h1>
            ...
            <div className="max-w-xl mx-auto mb-16 p-6 md:p-8 bg-primary/10 rounded-2xl border-2 border-primary/30 backdrop-blur-sm">
              <div className="flex items-center justify-center gap-4 md:gap-6">
                ...
                <div className="text-left">
                  <p className="text-primary font-black text-2xl md:text-3xl lg:text-4xl mb-1">{st("hero.everySaturday", lang)}</p>
                  <p className="text-foreground font-bold text-base md:text-lg lg:text-xl">{st("hero.location", lang)}</p>
                  <p className="text-muted-foreground text-sm md:text-base mt-1">{st("hero.hours", lang)}</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-8 max-w-lg mx-auto md:mx-0">
              <div className="text-center md:text-left">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground tracking-wide">{st("hero.stat.burgers", lang)}</p>
              </div>
              <div className="text-center md:text-left">
                <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary">10+</p>
                <p className="text-xs sm:text-sm text-muted-foreground tracking-wide">{st("hero.stat.dips", lang)}</p>
              </div>
              <div className="text-center md:text-left">
                <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary">100%</p>
                <p className="text-xs sm:text-sm text-muted-foreground tracking-wide">{st("hero.stat.halal", lang)}</p>
              </div>
            </div>
          </div>
